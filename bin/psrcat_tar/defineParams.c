...
void defineParameters(paramtype *defParam)
{
  ...
  addParameter(defParam,"FA","%10.3e","FA","(s^-11)","Tenth time deriv baryctr rotn frequency (s^-11)",2,1);
  addParameter(defParam,"FB","%10.3e","FB","(s^-12)","Eleventh time deriv baryctr rotn frequency (s^-12)",2,1);
  addParameter(defParam,"FC","%10.3e","FC","(s^-13)","Twelfth time deriv baryctr rotn frequency (s^-13)",2,1);
  addParameter(defParam,"DM2","%15.3f","DM2","(cm^-3 pc yr^-2)","Second time deriv of dispersion measure (cm**-3 pc yr^-2)",2,1);
